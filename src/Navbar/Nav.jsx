            ...
            <div className="hidden mr-24 sm:ml-6 sm:block items-center">
              <div className="flex space-x-4">
                <ul className='list-none flex m-4' id='nav'>
                  <li>
                    <a
                      href="/https://github.com/Karthi-cooper/sgcars.git"
                  ...
                  <li>
                    <a
                      href="/https://github.com/Karthi-cooper/sgcars.git/Navcollection"
                      className="rounded-md px-5 py-2 text-base font-medium text-white hover:bg-white hover:text-black"
                    >
                      Collection
                    </a>
                  ...
                  <li>
                    <a
                      href="/https://github.com/Karthi-cooper/sgcars.git/Contact"
                      className="rounded-md px-5 py-2 text-base font-medium text-white hover:bg-white hover:text-black"
                    >
                      Contact US
                    </a>
